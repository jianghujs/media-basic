...
var OpusEncoder = (function () {
    function OpusEncoder(sampling_rate, channels, app, frame_duration) {
        ...
        this.in_off = 0;
        this.out_ptr = 0;
        if (!OpusEncode.validFrameDuration(frame_duration))
        ...
        this.out_bytes = OpusEncode.getMaxFrameSize();
...
var OpusDecoder = (function () {
    function OpusDecoder(sampling_rate, channels) {
        ...
        this.in_ptr = _malloc(OpusEncode.getMaxFrameSize(channels));
        this.in_buf = HEAPU8.subarray(this.in_ptr, this.in_ptr + OpusEncode.getMaxFrameSize(channels));
        this.out_len = OpusEncode.getMaxSamplesPerChannel(sampling_rate);
